...
function getTranslation( page ){
	...
	if( ! tarajem[currTarjama][currMosshaf][page]){
		...
		jxr['tafsir'] = $.get("load_page_ayas.php?b_sura=" + b_sura + "&b_aya=" + b_aya + "&e_sura=" + e_sura + "&e_aya=" + e_aya + "&url=" + url , function(json){
...
async function doSearch() {
  ...
  // Send the search query to the PHP function using an HTTP GET request
